...
public class Exhibitions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString s = new SpannableString("Exhibitions");
        ...
        if(checkinternetservice()) {
            ...
            ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("exi");
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(final List<ParseObject> objects, ParseException e) {
                    ...
                    adapter = new MyAdapter(Exhibitions.this, list);
                    listView.setAdapter(adapter);
                }

            });
        }else{
            new AlertDialog.Builder(Exhibitions.this)
                    .setTitle("oops")

...
public class Techtainment  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkinternetservice()) {
            ...
            ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Tech");
            list = new ArrayList<SponorObject>();
                ...
                public void done(final List<ParseObject> objects, ParseException e) {
                    ...
                    if (objects.size() > 0 && e == null) {
                        for (int i = 0; i < objects.size(); i++) {
                            ...
                            SponorObject object = new SponorObject();
                    ...
                    adapter = new MyAdapter(Techtainment.this, list);
                    listView.setAdapter(adapter);
                }

            });
        }else{
            new AlertDialog.Builder(Techtainment.this)
                    .setTitle("oops")
